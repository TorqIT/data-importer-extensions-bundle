...
export const ImportAssetAdvancedTransformerForm = ({ settings, onChange }: ImportAssetAdvancedTransformerFormProps): React.JSX.Element => {
    ...
    return (
        <TransformerSettingsLayout>
            ...
            <Form.Item label="URL Property Name">
                <Input
                    onChange={ (e) => { update('urlPropertyName', e.target.value) } }
