...
export const ArithmeticTransformerForm = ({ settings, onChange }: ArithmeticTransformerFormProps): React.JSX.Element => {
    ...
    return (
        <TransformerSettingsLayout>
            <Form.Item label="Arithmetic Operator">
                <Select
                    onChange={ (v) => { update('arithmeticOperator', v) } }
            ...
            <Form.Item label="Static Number">
                <Input
                    onChange={ (e) => { update('staticNumber', e.target.value) } }
