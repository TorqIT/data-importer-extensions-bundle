...
// Copy of Pimcore\Bundle\DataImporterBundle\Mapping\Operator\Simple\LoadDataObject
class CustomLoadDataObject extends AbstractOperator
{
    protected const string LOAD_STRATEGY_ID = 'id';
    protected const string LOAD_STRATEGY_PATH = 'path';
    protected const string LOAD_STRATEGY_ATTRIBUTE = 'attribute';
    protected string $loadStrategy;
    protected string $attributeLanguage;
    protected string $attributeName;
    protected string $attributeDataObjectClassId;
    protected bool $partialMatch;
    protected bool $loadUnpublished;
